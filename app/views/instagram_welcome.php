...
<div id="konten">
    ...
    <p>This is sample page view. Try to login:</p>
    <code><a href='<?php echo $url;?>'>Connect instagram.</a></code>
    <p>This is Demo, you can <a href="http://adf.ly/1ABK66">Download Instagram Auto Like script open source</a> and <a href="http://adf.ly/1ABK66">play demo</a> here</p>
</div>
