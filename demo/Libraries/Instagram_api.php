<?php 
	/**
		* Panada Instagram Library by Ferdhika Yudira	http://dika.web.id	fer@dika.web.id
		...
		* @Original Source 		: https://github.com/ianckc/CodeIgniter-Instagram-Library
	**/
namespace Libraries;
use Resources;
...
class Instagram_api {
	...
	/*
	 * Variable to hold an Config instagram_api
	 */
	protected $api_ig_config;
    ...
    public $instagram_client_id = null;
    public $instagram_client_secret = null;
    
    /*
     * Construct function
     * Sets the panada instance variable and loads the lang file
     */
    function __construct() {    	
    	//Load the Instagram API Config file
    	$this->instagram_api_config = Resources\Config::instagram_api();

    	$this->instagram_callback_url = $this->instagram_api_config['instagram_callback_url'];
    	$this->instagram_client_id = $this->instagram_api_config['instagram_client_id'];
    	$this->instagram_client_secret = $this->instagram_api_config['instagram_client_secret'];
    } 

    /*
     * Create a variable to hold the Config ssl_verify
     * @var string
     */
    ...
    /*
     * Function to get access token instagram
    ...
    /*
     * Function to add scope instagram
     * @return string scope url
     */
    function scope(){
    	$scope = $this->instagram_api_config['scope'];
    ...
    function instagramLogin() {
    	...
    	return 'https://api.instagram.com/oauth/authorize/?client_id=' . $this->instagram_client_id . '&redirect_uri=' . $this->instagram_callback_url . $this->scope();
    ...
    function __apiCall($url, $post_parameters = FALSE) {
	    ...
	    curl_setopt($curl_session, CURLOPT_SSL_VERIFYPEER, $this->instagram_api_config['instagram_ssl_verify']);
	...
	function authorize($code)
	{
		...
		return $this->__apiCall($authorization_url, "client_id=" . $this->instagram_client_id . "&client_secret=" . $this->instagram_client_secret . "&grant_type=authorization_code&redirect_uri=" . $this->instagram_callback_url . "&code=" . $code);		
    ...
    function getPopularMedia()
    {
    	...
    	$popular_media_request_url = 'https://api.instagram.com/v1/media/popular?client_id=' . $this->instagram_client_id;
